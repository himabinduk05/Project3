...
<div id="section">
        <center>
<h2><u>POSTPONE PATIENT APPOINTMENT</u></h2>
<table border=0>

    <form:form name="patientDetails" action="./postpone.controller" commandName="cmdPatient">
...
<tr><br><center><td><input type="submit" name="postpone appointment" value="postpone appointment" onclick="return formValidation()"> </center>
</form:form>
</table>
